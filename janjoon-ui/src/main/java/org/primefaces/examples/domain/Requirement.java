...
public class Requirement implements Serializable {
    ...
    public Requirement(String model, String year, String manufacturer, String color) {
		this.model = model;
		this.year = year;
	...
	public Requirement(String model, String year, String manufacturer, String color, int price) {
		this.model = model;
		this.year = year;
		this.manufacturer = manufacturer;
		this.color = color;
	...
	public Requirement(String randomModel, int randomYear, String randomManufacturer, String randomColor) {
	...
	public boolean equals(Object obj) {
		...
		Requirement compare = (Requirement) obj;

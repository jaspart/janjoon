...
privileged aspect JJCriticityBean_Roo_ManagedBean {
    ...
    public HtmlPanelGrid JJCriticityBean.populateCreatePanel() {
        ...
        HtmlOutputText criticityLevelCreateOutput = (HtmlOutputText) application.createComponent(HtmlOutputText.COMPONENT_TYPE);
    ...
    public HtmlPanelGrid JJCriticityBean.populateEditPanel() {
        ...
        HtmlOutputText criticityLevelEditOutput = (HtmlOutputText) application.createComponent(HtmlOutputText.COMPONENT_TYPE);

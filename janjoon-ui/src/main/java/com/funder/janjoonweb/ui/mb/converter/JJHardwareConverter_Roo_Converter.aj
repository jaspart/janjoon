...
import com.funder.janjoonweb.ui.mb.converter.JJHardwareConverter;
...
privileged aspect JJHardwareConverter_Roo_Converter {
    ...
    declare @type: JJHardwareConverter: @FacesConverter("com.funder.janjoonweb.ui.mb.converter.JJHardwareConverter");
    
    @Autowired
    JJHardwareService JJHardwareConverter.jJHardwareService;
    
    public Object JJHardwareConverter.getAsObject(FacesContext context, UIComponent component, String value) {

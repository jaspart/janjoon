...
privileged aspect JJTestplanBean_Roo_ManagedBean {
    ...
    public HtmlPanelGrid JJTestplanBean.populateCreatePanel() {
        ...
        HtmlOutputText buildCreateOutput = (HtmlOutputText) application.createComponent(HtmlOutputText.COMPONENT_TYPE);
    ...
    public HtmlPanelGrid JJTestplanBean.populateEditPanel() {
        ...
        HtmlOutputText buildEditOutput = (HtmlOutputText) application.createComponent(HtmlOutputText.COMPONENT_TYPE);

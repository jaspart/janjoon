...
import com.funder.janjoonweb.ui.mb.converter.JJTaskConverter;
...
privileged aspect JJTaskConverter_Roo_Converter {
    ...
    declare @type: JJTaskConverter: @FacesConverter("com.funder.janjoonweb.ui.mb.converter.JJTaskConverter");

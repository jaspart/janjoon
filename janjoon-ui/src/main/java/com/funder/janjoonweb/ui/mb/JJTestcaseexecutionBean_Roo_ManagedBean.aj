...
privileged aspect JJTestcaseexecutionBean_Roo_ManagedBean {
    
    declare @type: JJTestcaseexecutionBean: @ManagedBean(name = "jJTestcaseexecutionBean");
    
    declare @type: JJTestcaseexecutionBean: @SessionScoped;
    
    @Autowired
    JJTestcaseexecutionService JJTestcaseexecutionBean.jJTestcaseexecutionService;
    
    @Autowired
    JJContactService JJTestcaseexecutionBean.jJContactService;
    
    @Autowired
    JJBuildService JJTestcaseexecutionBean.jJBuildService;
    
    @Autowired
    JJTestcaseService JJTestcaseexecutionBean.jJTestcaseService;
    
    private String JJTestcaseexecutionBean.name = "JJTestcaseexecutions";
    
    private JJTestcaseexecution JJTestcaseexecutionBean.JJTestcaseexecution_;
    
    private List<JJTestcaseexecution> JJTestcaseexecutionBean.allJJTestcaseexecutions;
    
    private boolean JJTestcaseexecutionBean.dataVisible = false;
    
    private List<String> JJTestcaseexecutionBean.columns;
    
    private HtmlPanelGrid JJTestcaseexecutionBean.createPanelGrid;
    
    private HtmlPanelGrid JJTestcaseexecutionBean.editPanelGrid;
    ...
    public String JJTestcaseexecutionBean.getName() {
        return name;
    }
    
    public List<String> JJTestcaseexecutionBean.getColumns() {
        return columns;
    }
    
    public List<JJTestcaseexecution> JJTestcaseexecutionBean.getAllJJTestcaseexecutions() {
        return allJJTestcaseexecutions;
    }
    
    public void JJTestcaseexecutionBean.setAllJJTestcaseexecutions(List<JJTestcaseexecution> allJJTestcaseexecutions) {
        this.allJJTestcaseexecutions = allJJTestcaseexecutions;
    }
    
    public String JJTestcaseexecutionBean.findAllJJTestcaseexecutions() {
        allJJTestcaseexecutions = jJTestcaseexecutionService.findAllJJTestcaseexecutions();
        dataVisible = !allJJTestcaseexecutions.isEmpty();
        return null;
    }
    
    public boolean JJTestcaseexecutionBean.isDataVisible() {
        return dataVisible;
    }
    
    public void JJTestcaseexecutionBean.setDataVisible(boolean dataVisible) {
        this.dataVisible = dataVisible;
    }
    
    public HtmlPanelGrid JJTestcaseexecutionBean.getCreatePanelGrid() {
    ...
    public void JJTestcaseexecutionBean.setCreatePanelGrid(HtmlPanelGrid createPanelGrid) {
        this.createPanelGrid = createPanelGrid;
    }
    
    public HtmlPanelGrid JJTestcaseexecutionBean.getEditPanelGrid() {
    ...
    public void JJTestcaseexecutionBean.setEditPanelGrid(HtmlPanelGrid editPanelGrid) {
        this.editPanelGrid = editPanelGrid;
    }
    
    public HtmlPanelGrid JJTestcaseexecutionBean.getViewPanelGrid() {
        return populateViewPanel();
    }
    
    public void JJTestcaseexecutionBean.setViewPanelGrid(HtmlPanelGrid viewPanelGrid) {
        this.viewPanelGrid = viewPanelGrid;
    }
    
    public HtmlPanelGrid JJTestcaseexecutionBean.populateCreatePanel() {
        ...
        nameCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.name}", String.class));
        ...
        descriptionCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.description}", String.class));
        ...
        creationDateCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.creationDate}", Date.class));
        ...
        createdByCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.createdBy}", JJContact.class));
        createdByCreateInput.setCompleteMethod(expressionFactory.createMethodExpression(elContext, "#{jJTestcaseexecutionBean.completeCreatedBy}", List.class, new Class[] { String.class }));
        ...
        updatedDateCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.updatedDate}", Date.class));
        ...
        updatedByCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.updatedBy}", JJContact.class));
        updatedByCreateInput.setCompleteMethod(expressionFactory.createMethodExpression(elContext, "#{jJTestcaseexecutionBean.completeUpdatedBy}", List.class, new Class[] { String.class }));
        ...
        enabledCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.enabled}", Boolean.class));
        ...
        buildCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.build}", JJBuild.class));
        buildCreateInput.setCompleteMethod(expressionFactory.createMethodExpression(elContext, "#{jJTestcaseexecutionBean.completeBuild}", List.class, new Class[] { String.class }));
        ...
        buildTestcaseCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.buildTestcase}", JJTestcase.class));
        buildTestcaseCreateInput.setCompleteMethod(expressionFactory.createMethodExpression(elContext, "#{jJTestcaseexecutionBean.completeBuildTestcase}", List.class, new Class[] { String.class }));
        ...
        passedCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.passed}", Boolean.class));
    ...
    public HtmlPanelGrid JJTestcaseexecutionBean.populateEditPanel() {
        FacesContext facesContext = FacesContext.getCurrentInstance();
        javax.faces.application.Application application = facesContext.getApplication();
        ExpressionFactory expressionFactory = application.getExpressionFactory();
        ELContext elContext = facesContext.getELContext();
        ...
        nameEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.name}", String.class));
        ...
        descriptionEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.description}", String.class));
        ...
        creationDateEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.creationDate}", Date.class));
        ...
        createdByEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.createdBy}", JJContact.class));
        createdByEditInput.setCompleteMethod(expressionFactory.createMethodExpression(elContext, "#{jJTestcaseexecutionBean.completeCreatedBy}", List.class, new Class[] { String.class }));
        ...
        updatedDateEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.updatedDate}", Date.class));
        ...
        updatedByEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.updatedBy}", JJContact.class));
        updatedByEditInput.setCompleteMethod(expressionFactory.createMethodExpression(elContext, "#{jJTestcaseexecutionBean.completeUpdatedBy}", List.class, new Class[] { String.class }));
        ...
        enabledEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.enabled}", Boolean.class));
        ...
        buildEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.build}", JJBuild.class));
        buildEditInput.setCompleteMethod(expressionFactory.createMethodExpression(elContext, "#{jJTestcaseexecutionBean.completeBuild}", List.class, new Class[] { String.class }));
        ...
        buildTestcaseEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.buildTestcase}", JJTestcase.class));
        buildTestcaseEditInput.setCompleteMethod(expressionFactory.createMethodExpression(elContext, "#{jJTestcaseexecutionBean.completeBuildTestcase}", List.class, new Class[] { String.class }));
        ...
        passedEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.passed}", Boolean.class));
    ...
    public HtmlPanelGrid JJTestcaseexecutionBean.populateViewPanel() {
        FacesContext facesContext = FacesContext.getCurrentInstance();
        javax.faces.application.Application application = facesContext.getApplication();
        ExpressionFactory expressionFactory = application.getExpressionFactory();
        ELContext elContext = facesContext.getELContext();
        ...
        nameValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.name}", String.class));
        ...
        descriptionValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.description}", String.class));
        ...
        creationDateValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.creationDate}", Date.class));
        ...
        createdByValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.createdBy}", JJContact.class));
        ...
        updatedDateValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.updatedDate}", Date.class));
        ...
        updatedByValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.updatedBy}", JJContact.class));
        ...
        enabledValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.enabled}", String.class));
        ...
        buildValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.build}", JJBuild.class));
        ...
        buildTestcaseValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJTestcaseexecutionBean.JJTestcaseexecution_.buildTestcase}", JJTestcase.class));
    ...
    public JJTestcaseexecution JJTestcaseexecutionBean.getJJTestcaseexecution_() {
        if (JJTestcaseexecution_ == null) {
            JJTestcaseexecution_ = new JJTestcaseexecution();
        }
        return JJTestcaseexecution_;
    }
    
    public void JJTestcaseexecutionBean.setJJTestcaseexecution_(JJTestcaseexecution JJTestcaseexecution_) {
        this.JJTestcaseexecution_ = JJTestcaseexecution_;
    }
    
    public List<JJContact> JJTestcaseexecutionBean.completeCreatedBy(String query) {
    ...
    public List<JJContact> JJTestcaseexecutionBean.completeUpdatedBy(String query) {
        List<JJContact> suggestions = new ArrayList<JJContact>();
        for (JJContact jJContact : jJContactService.findAllJJContacts()) {
            String jJContactStr = String.valueOf(jJContact.getName() +  " "  + jJContact.getDescription() +  " "  + jJContact.getCreationDate() +  " "  + jJContact.getUpdatedDate());
            if (jJContactStr.toLowerCase().startsWith(query.toLowerCase())) {
    ...
    public List<JJBuild> JJTestcaseexecutionBean.completeBuild(String query) {
    ...
    public List<JJTestcase> JJTestcaseexecutionBean.completeBuildTestcase(String query) {
    ...
    public boolean JJTestcaseexecutionBean.isCreateDialogVisible() {
        return createDialogVisible;
    }
    
    public void JJTestcaseexecutionBean.setCreateDialogVisible(boolean createDialogVisible) {
        this.createDialogVisible = createDialogVisible;
    }
    
    public String JJTestcaseexecutionBean.displayList() {
        createDialogVisible = false;
        findAllJJTestcaseexecutions();
        return "JJTestcaseexecution_";
    }
    
    public String JJTestcaseexecutionBean.displayCreateDialog() {
        JJTestcaseexecution_ = new JJTestcaseexecution();
        createDialogVisible = true;
        return "JJTestcaseexecution_";
    }
    
    public String JJTestcaseexecutionBean.persist() {
        String message = "";
        if (JJTestcaseexecution_.getId() != null) {
            jJTestcaseexecutionService.updateJJTestcaseexecution(JJTestcaseexecution_);
            message = "message_successfully_updated";
        } else {
            jJTestcaseexecutionService.saveJJTestcaseexecution(JJTestcaseexecution_);
        ...
        FacesMessage facesMessage = MessageFactory.getMessage(message, "JJTestcaseexecution");
        FacesContext.getCurrentInstance().addMessage(null, facesMessage);
        reset();
        return findAllJJTestcaseexecutions();
    }
    
    public String JJTestcaseexecutionBean.delete() {
        jJTestcaseexecutionService.deleteJJTestcaseexecution(JJTestcaseexecution_);
        FacesMessage facesMessage = MessageFactory.getMessage("message_successfully_deleted", "JJTestcaseexecution");
        FacesContext.getCurrentInstance().addMessage(null, facesMessage);
        reset();
        return findAllJJTestcaseexecutions();
    }
    ...
    public void JJTestcaseexecutionBean.handleDialogClose(CloseEvent event) {
        reset();
    }

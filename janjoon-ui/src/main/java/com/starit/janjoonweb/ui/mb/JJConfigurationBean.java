...
public class JJConfigurationBean {
	...
	public HtmlPanelGrid populatePanelCreate()
	{
        ...
        Editor descriptionCreateInput = (Editor) application.createComponent(Editor.COMPONENT_TYPE);
	...
	public HtmlPanelGrid populatePanelEdit()
	{
        ...
        Editor descriptionEditInput = (Editor) application.createComponent(Editor.COMPONENT_TYPE);
	...
	public HtmlPanelGrid populatePanelView()
	{
        ...
        createdByValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJConfigurationBean.JJConfiguration_.createdBy.name}", String.class));        
        ...
        updatedByValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJConfigurationBean.JJConfiguration_.updatedBy.name}", String.class));

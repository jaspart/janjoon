...
privileged aspect JJSoftwareBean_Roo_ManagedBean {
    
    declare @type: JJSoftwareBean: @ManagedBean(name = "jJSoftwareBean");
    
    declare @type: JJSoftwareBean: @SessionScoped;
    
    @Autowired
    JJSoftwareService JJSoftwareBean.jJSoftwareService;
    
    @Autowired
    JJContactService JJSoftwareBean.jJContactService;
    
    @Autowired
    JJTestcaseService JJSoftwareBean.jJTestcaseService;
    
    private String JJSoftwareBean.name = "JJSoftwares";
    
    private JJSoftware JJSoftwareBean.JJSoftware_;
    
    private List<JJSoftware> JJSoftwareBean.allJJSoftwares;
    
    private boolean JJSoftwareBean.dataVisible = false;
    
    private List<String> JJSoftwareBean.columns;
    
    private HtmlPanelGrid JJSoftwareBean.createPanelGrid;
    
    private HtmlPanelGrid JJSoftwareBean.editPanelGrid;
    
    private HtmlPanelGrid JJSoftwareBean.viewPanelGrid;
    
    private boolean JJSoftwareBean.createDialogVisible = false;
    
    @PostConstruct
    public void JJSoftwareBean.init() {
    ...
    public String JJSoftwareBean.getName() {
        return name;
    }
    
    public List<String> JJSoftwareBean.getColumns() {
        return columns;
    }
    
    public List<JJSoftware> JJSoftwareBean.getAllJJSoftwares() {
        return allJJSoftwares;
    }
    
    public void JJSoftwareBean.setAllJJSoftwares(List<JJSoftware> allJJSoftwares) {
        this.allJJSoftwares = allJJSoftwares;
    }
    
    public String JJSoftwareBean.findAllJJSoftwares() {
        allJJSoftwares = jJSoftwareService.findAllJJSoftwares();
        dataVisible = !allJJSoftwares.isEmpty();
        return null;
    }
    
    public boolean JJSoftwareBean.isDataVisible() {
        return dataVisible;
    }
    
    public void JJSoftwareBean.setDataVisible(boolean dataVisible) {
        this.dataVisible = dataVisible;
    }
    
    public HtmlPanelGrid JJSoftwareBean.getCreatePanelGrid() {
    ...
    public void JJSoftwareBean.setCreatePanelGrid(HtmlPanelGrid createPanelGrid) {
        this.createPanelGrid = createPanelGrid;
    }
    
    public HtmlPanelGrid JJSoftwareBean.getEditPanelGrid() {
    ...
    public void JJSoftwareBean.setEditPanelGrid(HtmlPanelGrid editPanelGrid) {
        this.editPanelGrid = editPanelGrid;
    }
    
    public HtmlPanelGrid JJSoftwareBean.getViewPanelGrid() {
        return populateViewPanel();
    }
    
    public void JJSoftwareBean.setViewPanelGrid(HtmlPanelGrid viewPanelGrid) {
        this.viewPanelGrid = viewPanelGrid;
    }
    
    public HtmlPanelGrid JJSoftwareBean.populateCreatePanel() {
        ...
        nameCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSoftwareBean.JJSoftware_.name}", String.class));
        ...
        descriptionCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSoftwareBean.JJSoftware_.description}", String.class));
        ...
        creationDateCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSoftwareBean.JJSoftware_.creationDate}", Date.class));
        ...
        createdByCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSoftwareBean.JJSoftware_.createdBy}", JJContact.class));
        createdByCreateInput.setCompleteMethod(expressionFactory.createMethodExpression(elContext, "#{jJSoftwareBean.completeCreatedBy}", List.class, new Class[] { String.class }));
        ...
        updatedDateCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSoftwareBean.JJSoftware_.updatedDate}", Date.class));
        ...
        updatedByCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSoftwareBean.JJSoftware_.updatedBy}", JJContact.class));
        updatedByCreateInput.setCompleteMethod(expressionFactory.createMethodExpression(elContext, "#{jJSoftwareBean.completeUpdatedBy}", List.class, new Class[] { String.class }));
        ...
        enabledCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSoftwareBean.JJSoftware_.enabled}", Boolean.class));
        ...
        testcaseCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSoftwareBean.JJSoftware_.testcase}", JJTestcase.class));
        testcaseCreateInput.setCompleteMethod(expressionFactory.createMethodExpression(elContext, "#{jJSoftwareBean.completeTestcase}", List.class, new Class[] { String.class }));
    ...
    public HtmlPanelGrid JJSoftwareBean.populateEditPanel() {
        FacesContext facesContext = FacesContext.getCurrentInstance();
        javax.faces.application.Application application = facesContext.getApplication();
        ExpressionFactory expressionFactory = application.getExpressionFactory();
        ELContext elContext = facesContext.getELContext();
        ...
        nameEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSoftwareBean.JJSoftware_.name}", String.class));
        ...
        descriptionEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSoftwareBean.JJSoftware_.description}", String.class));
        ...
        creationDateEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSoftwareBean.JJSoftware_.creationDate}", Date.class));
        ...
        createdByEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSoftwareBean.JJSoftware_.createdBy}", JJContact.class));
        createdByEditInput.setCompleteMethod(expressionFactory.createMethodExpression(elContext, "#{jJSoftwareBean.completeCreatedBy}", List.class, new Class[] { String.class }));
        ...
        updatedDateEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSoftwareBean.JJSoftware_.updatedDate}", Date.class));
        ...
        updatedByEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSoftwareBean.JJSoftware_.updatedBy}", JJContact.class));
        updatedByEditInput.setCompleteMethod(expressionFactory.createMethodExpression(elContext, "#{jJSoftwareBean.completeUpdatedBy}", List.class, new Class[] { String.class }));
        ...
        enabledEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSoftwareBean.JJSoftware_.enabled}", Boolean.class));
        ...
        testcaseEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSoftwareBean.JJSoftware_.testcase}", JJTestcase.class));
        testcaseEditInput.setCompleteMethod(expressionFactory.createMethodExpression(elContext, "#{jJSoftwareBean.completeTestcase}", List.class, new Class[] { String.class }));
    ...
    public HtmlPanelGrid JJSoftwareBean.populateViewPanel() {
        FacesContext facesContext = FacesContext.getCurrentInstance();
        javax.faces.application.Application application = facesContext.getApplication();
        ExpressionFactory expressionFactory = application.getExpressionFactory();
        ELContext elContext = facesContext.getELContext();
        ...
        nameValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSoftwareBean.JJSoftware_.name}", String.class));
        ...
        descriptionValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSoftwareBean.JJSoftware_.description}", String.class));
        ...
        creationDateValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSoftwareBean.JJSoftware_.creationDate}", Date.class));
        ...
        createdByValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSoftwareBean.JJSoftware_.createdBy}", JJContact.class));
        ...
        updatedDateValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSoftwareBean.JJSoftware_.updatedDate}", Date.class));
        ...
        updatedByValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSoftwareBean.JJSoftware_.updatedBy}", JJContact.class));
        ...
        enabledValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSoftwareBean.JJSoftware_.enabled}", String.class));
        ...
        testcaseValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSoftwareBean.JJSoftware_.testcase}", JJTestcase.class));
    ...
    public JJSoftware JJSoftwareBean.getJJSoftware_() {
        if (JJSoftware_ == null) {
            JJSoftware_ = new JJSoftware();
        }
        return JJSoftware_;
    }
    
    public void JJSoftwareBean.setJJSoftware_(JJSoftware JJSoftware_) {
        this.JJSoftware_ = JJSoftware_;
    }
    
    public List<JJContact> JJSoftwareBean.completeCreatedBy(String query) {
    ...
    public List<JJContact> JJSoftwareBean.completeUpdatedBy(String query) {
        List<JJContact> suggestions = new ArrayList<JJContact>();
        for (JJContact jJContact : jJContactService.findAllJJContacts()) {
            String jJContactStr = String.valueOf(jJContact.getName() +  " "  + jJContact.getDescription() +  " "  + jJContact.getCreationDate() +  " "  + jJContact.getUpdatedDate());
            if (jJContactStr.toLowerCase().startsWith(query.toLowerCase())) {
    ...
    public List<JJTestcase> JJSoftwareBean.completeTestcase(String query) {
    ...
    public String JJSoftwareBean.onEdit() {
        return null;
    }
    
    public boolean JJSoftwareBean.isCreateDialogVisible() {
        return createDialogVisible;
    }
    
    public void JJSoftwareBean.setCreateDialogVisible(boolean createDialogVisible) {
        this.createDialogVisible = createDialogVisible;
    }
    
    public String JJSoftwareBean.displayList() {
        createDialogVisible = false;
        findAllJJSoftwares();
        return "JJSoftware_";
    }
    
    public String JJSoftwareBean.displayCreateDialog() {
        JJSoftware_ = new JJSoftware();
        createDialogVisible = true;
        return "JJSoftware_";
    }
    
    public String JJSoftwareBean.persist() {
        String message = "";
        if (JJSoftware_.getId() != null) {
            jJSoftwareService.updateJJSoftware(JJSoftware_);
            message = "message_successfully_updated";
        } else {
            jJSoftwareService.saveJJSoftware(JJSoftware_);
        ...
        FacesMessage facesMessage = MessageFactory.getMessage(message, "JJSoftware");
        FacesContext.getCurrentInstance().addMessage(null, facesMessage);
        reset();
        return findAllJJSoftwares();
    }
    
    public String JJSoftwareBean.delete() {
        jJSoftwareService.deleteJJSoftware(JJSoftware_);
        FacesMessage facesMessage = MessageFactory.getMessage("message_successfully_deleted", "JJSoftware");
        FacesContext.getCurrentInstance().addMessage(null, facesMessage);
        reset();
        return findAllJJSoftwares();
    }
    
    public void JJSoftwareBean.reset() {
        JJSoftware_ = null;
        createDialogVisible = false;
    }
    
    public void JJSoftwareBean.handleDialogClose(CloseEvent event) {
        reset();
    }

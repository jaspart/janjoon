...
public class CKEditorUploadServlet extends HttpServlet {
	...
	private static final String CKEDITOR_DIR= System.getProperty("user.home")+File.separator+"upload"+File.separator+"images";
...
//	    uploadedFileService.saveUploadedFile(uploadedFile);
	  ...
	  String pathToFile = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath() + "/pages/ckeditor/getimage?imageId=" + uploadedFile.getName();

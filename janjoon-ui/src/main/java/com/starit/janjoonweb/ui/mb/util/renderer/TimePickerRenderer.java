...
public class TimePickerRenderer
	...
	protected void encodeMarkup(final FacesContext fc,
		...
		writer.writeAttribute("type", timepicker.isInline() ? "hidden" : "text",
				null);
		...
		if (!"focus".equals(timepicker.getShowOn())) {
			...
			writer.writeAttribute("class", TimePicker.BUTTON_TRIGGER_ICON_CLASS,
					null);
			writer.endElement("span");

			writer.startElement("span", null);
			writer.writeAttribute("class", TimePicker.BUTTON_TRIGGER_TEXT_CLASS,
					null);

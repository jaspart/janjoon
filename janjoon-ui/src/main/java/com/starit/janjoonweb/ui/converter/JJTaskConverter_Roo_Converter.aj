...
import com.starit.janjoonweb.ui.converter.JJTaskConverter;
...
privileged aspect JJTaskConverter_Roo_Converter {
    ...
    declare @type: JJTaskConverter: @FacesConverter("com.starit.janjoonweb.ui.converter.JJTaskConverter");

	...
	public List<JJMessage> getAlertMessages() {
		...
		if (alertMessages == null && ((LoginBean) LoginBean.findBean("loginBean")).isEnable()) {
			alertMessages = jJMessageService.getAlertMessages(LoginBean.getProject(), LoginBean.getProduct(),
			        LoginBean.getCompany(), ((LoginBean) LoginBean.findBean("loginBean")).getContact());
		}
...
//	}
	...
	public void initJJMessageLayout(ComponentSystemEvent e) {
		...
		if (mainMessages == null && login.isEnable()) {
			...
			mainMessages = new LazyMessageDataModel(jJMessageService, LoginBean.getProject(), LoginBean.getProduct(),
			        LoginBean.getCompany(), ((LoginBean) LoginBean.findBean("loginBean")).getContact());
		}
	}
	...
	public void initJJmessageTable(ComponentSystemEvent e) {
		...
		if (!loadFiltredJJmessage && login.isEnable()) {
			...
			for (JJMessage mes : jJMessageService.getActifMessages(LoginBean.getProject(), LoginBean.getProduct(),
				...
				if (mes.getProject() != null && !listContaines(projectes, mes.getProject()))
					projectes.add(mes.getProject());
				if (mes.getCriticity() != null && !listContaines(criticities, mes.getCriticity()))
					criticities.add(mes.getCriticity());
				if (mes.getStatus() != null && !listContaines(status, mes.getStatus()))
	...
	public boolean haveObject(JJMessage mes) {
		return mes.getBug() != null || mes.getRequirement() != null || mes.getTestcase() != null;
	}
		...
		if (mes.getBug() != null)
			FacesContext.getCurrentInstance().getExternalContext()
			        .redirect(FacesContext.getCurrentInstance().getExternalContext().getRequestContextPath()
			                + "/pages/bug.jsf?bug=" + mes.getBug().getId() + "&faces-redirect=true");

		else if (mes.getRequirement() != null)
			FacesContext.getCurrentInstance().getExternalContext()
			        .redirect(FacesContext.getCurrentInstance().getExternalContext().getRequestContextPath()
			                + "/pages/requirement.jsf?requirement=" + mes.getRequirement().getId()
			                + "&faces-redirect=true");

		else if (mes.getTestcase() != null)
			FacesContext.getCurrentInstance().getExternalContext()
			        .redirect(FacesContext.getCurrentInstance().getExternalContext().getRequestContextPath()
			                + "/pages/test.jsf?testcase=" + mes.getTestcase().getId() + "&faces-redirect=true");
...
//		setCreateDialogVisible(false);
	...
	public HtmlPanelGrid populateMessagePanel() {
		...
		if (viewedMessage != null) {
			...
			messageValue.setValueExpression("value", expressionFactory.createValueExpression(elContext,
			...
			if (viewedMessage.getBug() != null) {
				...
				bugValue.setValueExpression("value", expressionFactory.createValueExpression(elContext,
			...
			if (viewedMessage.getBuild() != null) {
				...
				buildValue.setValueExpression("value", expressionFactory.createValueExpression(elContext,
			...
			if (viewedMessage.getChapter() != null) {
				...
				HtmlOutputText chapterValue = (HtmlOutputText) application
				        .createComponent(HtmlOutputText.COMPONENT_TYPE);
				chapterValue.setValueExpression("value", expressionFactory.createValueExpression(elContext,
			...
			if (viewedMessage.getContact() != null) {
				...
				HtmlOutputText contactValue = (HtmlOutputText) application
				        .createComponent(HtmlOutputText.COMPONENT_TYPE);
				contactValue.setValueExpression("value", expressionFactory.createValueExpression(elContext,
			...
			if (viewedMessage.getCriticity() != null) {
				...
				HtmlOutputText criticityValue = (HtmlOutputText) application
				        .createComponent(HtmlOutputText.COMPONENT_TYPE);
				criticityValue.setValueExpression("value", expressionFactory.createValueExpression(elContext,
			...
			if (viewedMessage.getImportance() != null) {
				...
				HtmlOutputText importanceValue = (HtmlOutputText) application
				        .createComponent(HtmlOutputText.COMPONENT_TYPE);
				importanceValue.setValueExpression("value", expressionFactory.createValueExpression(elContext,
			...
			if (viewedMessage.getProduct() != null) {
				...
				HtmlOutputText productValue = (HtmlOutputText) application
				        .createComponent(HtmlOutputText.COMPONENT_TYPE);
				productValue.setValueExpression("value", expressionFactory.createValueExpression(elContext,
				...
				if (viewedMessage.getVersioning() != null) {
					...
					HtmlOutputText versioningValue = (HtmlOutputText) application
					        .createComponent(HtmlOutputText.COMPONENT_TYPE);
					versioningValue.setValueExpression("value", expressionFactory.createValueExpression(elContext,
					        "#{jJMessageBean.viewedMessage.versioning.name}", String.class));
			...
			if (viewedMessage.getProject() != null) {
				...
				HtmlOutputText projectValue = (HtmlOutputText) application
				        .createComponent(HtmlOutputText.COMPONENT_TYPE);
				projectValue.setValueExpression("value", expressionFactory.createValueExpression(elContext,
				        "#{jJMessageBean.viewedMessage.project.name}", String.class));
			...
			if (viewedMessage.getRequirement() != null) {
				...
				HtmlOutputText requirementValue = (HtmlOutputText) application
				        .createComponent(HtmlOutputText.COMPONENT_TYPE);
				requirementValue.setValueExpression("value", expressionFactory.createValueExpression(elContext,
				        "#{jJMessageBean.viewedMessage.requirement.name}", String.class));
			...
			if (viewedMessage.getSprint() != null) {
				...
				HtmlOutputText sprintValue = (HtmlOutputText) application
				        .createComponent(HtmlOutputText.COMPONENT_TYPE);
				sprintValue.setValueExpression("value", expressionFactory.createValueExpression(elContext,
				        "#{jJMessageBean.viewedMessage.sprint.name}", String.class));
			...
			if (viewedMessage.getStatus() != null) {
				...
				HtmlOutputText statusValue = (HtmlOutputText) application
				        .createComponent(HtmlOutputText.COMPONENT_TYPE);
				statusValue.setValueExpression("value", expressionFactory.createValueExpression(elContext,
				        "#{jJMessageBean.viewedMessage.status.name}", String.class));
			...
			if (viewedMessage.getTask() != null) {
				...
				taskValue.setValueExpression("value", expressionFactory.createValueExpression(elContext,
				        "#{jJMessageBean.viewedMessage.task.name}", String.class));
			...
			if (viewedMessage.getTestcase() != null) {
				...
				HtmlOutputText testcaseValue = (HtmlOutputText) application
				        .createComponent(HtmlOutputText.COMPONENT_TYPE);
				testcaseValue.setValueExpression("value", expressionFactory.createValueExpression(elContext,
				        "#{jJMessageBean.viewedMessage.testcase.name}", String.class));
			...
			if (viewedMessage.getTeststep() != null) {
				...
				HtmlOutputText teststepValue = (HtmlOutputText) application
				        .createComponent(HtmlOutputText.COMPONENT_TYPE);
				teststepValue.setValueExpression("value", expressionFactory.createValueExpression(elContext,
				        "#{jJMessageBean.viewedMessage.teststep.name}", String.class));

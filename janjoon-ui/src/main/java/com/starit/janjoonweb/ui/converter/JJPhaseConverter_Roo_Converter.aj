...
import com.starit.janjoonweb.ui.converter.JJPhaseConverter;
...
privileged aspect JJPhaseConverter_Roo_Converter {
    ...
    declare @type: JJPhaseConverter: @FacesConverter("com.starit.janjoonweb.ui.converter.JJPhaseConverter");

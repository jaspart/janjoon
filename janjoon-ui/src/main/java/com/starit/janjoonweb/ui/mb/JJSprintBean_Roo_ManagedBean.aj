...
privileged aspect JJSprintBean_Roo_ManagedBean {
    ...
    public HtmlPanelGrid JJSprintBean.populateCreatePanel() {
        ...
        startDateCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSprintBean.JJSprint_.startDate}", Date.class));
        ...
        endDateCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSprintBean.JJSprint_.endDate}", Date.class));
    ...
    public HtmlPanelGrid JJSprintBean.populateEditPanel() {
        ...
        startDateEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSprintBean.JJSprint_.startDate}", Date.class));
        ...
        endDateEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSprintBean.JJSprint_.endDate}", Date.class));
    ...
    public HtmlPanelGrid JJSprintBean.populateViewPanel() {
        ...
        startDateValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSprintBean.JJSprint_.startDate}", Date.class));
        ...
        endDateValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{jJSprintBean.JJSprint_.endDate}", Date.class));

...
privileged aspect JJSprintBean_Roo_ManagedBean {
	...
	public HtmlPanelGrid JJSprintBean.populateCreatePanel() {
		...
		nameCreateInput.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{jJSprintBean.JJSprint_.name}", String.class));
		...
		descriptionCreateInput.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{jJSprintBean.JJSprint_.description}", String.class));
		...
		creationDateCreateInput.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{jJSprintBean.JJSprint_.creationDate}", Date.class));
		...
		createdByCreateInput
				.setValueExpression("value", expressionFactory
						.createValueExpression(elContext,
								"#{jJSprintBean.JJSprint_.createdBy}",
								JJContact.class));
		createdByCreateInput.setCompleteMethod(expressionFactory
				.createMethodExpression(elContext,
						"#{jJSprintBean.completeCreatedBy}", List.class,
		...
		updatedDateCreateInput.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{jJSprintBean.JJSprint_.updatedDate}", Date.class));
		...
		updatedByCreateInput
				.setValueExpression("value", expressionFactory
						.createValueExpression(elContext,
								"#{jJSprintBean.JJSprint_.updatedBy}",
								JJContact.class));
		updatedByCreateInput.setCompleteMethod(expressionFactory
				.createMethodExpression(elContext,
						"#{jJSprintBean.completeUpdatedBy}", List.class,
						new Class[] { String.class }));
		...
		enabledCreateInput.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{jJSprintBean.JJSprint_.enabled}", Boolean.class));
		...
		OutputLabel orderingCreateOutput = (OutputLabel) application
				.createComponent(OutputLabel.COMPONENT_TYPE);
		...
		Spinner orderingCreateInput = (Spinner) application
				.createComponent(Spinner.COMPONENT_TYPE);
		orderingCreateInput.setId("orderingCreateInput");
		orderingCreateInput.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{jJSprintBean.JJSprint_.ordering}", Integer.class));
		orderingCreateInput.setRequired(false);

		htmlPanelGrid.getChildren().add(orderingCreateInput);

		Message orderingCreateInputMessage = (Message) application
				.createComponent(Message.COMPONENT_TYPE);
		...
		OutputLabel projectCreateOutput = (OutputLabel) application
				.createComponent(OutputLabel.COMPONENT_TYPE);
		...
		AutoComplete projectCreateInput = (AutoComplete) application
				.createComponent(AutoComplete.COMPONENT_TYPE);
		projectCreateInput.setId("projectCreateInput");
		projectCreateInput.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{jJSprintBean.JJSprint_.project}", JJProject.class));
		projectCreateInput.setCompleteMethod(expressionFactory
				.createMethodExpression(elContext,
						"#{jJSprintBean.completeProject}", List.class,
						new Class[] { String.class }));
		projectCreateInput.setDropdown(true);
		projectCreateInput.setValueExpression("var", expressionFactory
				.createValueExpression(elContext, "project", String.class));
		projectCreateInput
				.setValueExpression(
						"itemLabel",
						expressionFactory
								.createValueExpression(
										elContext,
										"#{project.name} #{project.description} #{project.creationDate} #{project.updatedDate}",
										String.class));
		projectCreateInput.setValueExpression("itemValue",
				expressionFactory.createValueExpression(elContext,
						"#{project}", JJProject.class));
		...
		Message projectCreateInputMessage = (Message) application
				.createComponent(Message.COMPONENT_TYPE);
		...
		HtmlOutputText buildsCreateOutput = (HtmlOutputText) application
		...
		HtmlOutputText buildsCreateInput = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		buildsCreateInput.setId("buildsCreateInput");
		buildsCreateInput
				.setValue("This relationship is managed from the JJBuild side");
		htmlPanelGrid.getChildren().add(buildsCreateInput);

		Message buildsCreateInputMessage = (Message) application
				.createComponent(Message.COMPONENT_TYPE);
		...
		HtmlOutputText obstaclesCreateOutput = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		...
		HtmlOutputText obstaclesCreateInput = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		obstaclesCreateInput.setId("obstaclesCreateInput");
		obstaclesCreateInput
				.setValue("This relationship is managed from the JJTask side");
		htmlPanelGrid.getChildren().add(obstaclesCreateInput);

		Message obstaclesCreateInputMessage = (Message) application
				.createComponent(Message.COMPONENT_TYPE);
		...
		OutputLabel contactsCreateOutput = (OutputLabel) application
				.createComponent(OutputLabel.COMPONENT_TYPE);
		...
		SelectManyMenu contactsCreateInput = (SelectManyMenu) application
		...
		contactsCreateInput.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{jJSprintBean.selectedContacts}", List.class));
		UISelectItems contactsCreateInputItems = (UISelectItems) application
				.createComponent(UISelectItems.COMPONENT_TYPE);
		contactsCreateInputItems.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{jJContactBean.allJJContacts}", List.class));
		contactsCreateInput.setRequired(false);
		contactsCreateInputItems.setValueExpression("var", expressionFactory
				.createValueExpression(elContext, "jJContact", String.class));
		contactsCreateInputItems.setValueExpression("itemLabel",
				expressionFactory.createValueExpression(elContext,
						"#{jJContact}", String.class));
		contactsCreateInputItems.setValueExpression("itemValue",
				expressionFactory.createValueExpression(elContext,
						"#{jJContact}", JJContact.class));
		contactsCreateInput.getChildren().add(contactsCreateInputItems);
		htmlPanelGrid.getChildren().add(contactsCreateInput);

		Message contactsCreateInputMessage = (Message) application
				.createComponent(Message.COMPONENT_TYPE);
	...
	public HtmlPanelGrid JJSprintBean.populateEditPanel() {
		...
		OutputLabel orderingEditOutput = (OutputLabel) application
				.createComponent(OutputLabel.COMPONENT_TYPE);
		...
		Spinner orderingEditInput = (Spinner) application
				.createComponent(Spinner.COMPONENT_TYPE);
		orderingEditInput.setId("orderingEditInput");
		orderingEditInput.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{jJSprintBean.JJSprint_.ordering}", Integer.class));
		...
		Message orderingEditInputMessage = (Message) application
				.createComponent(Message.COMPONENT_TYPE);
		...
		OutputLabel projectEditOutput = (OutputLabel) application
				.createComponent(OutputLabel.COMPONENT_TYPE);
		...
		AutoComplete projectEditInput = (AutoComplete) application
				.createComponent(AutoComplete.COMPONENT_TYPE);
		projectEditInput.setId("projectEditInput");
		projectEditInput.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{jJSprintBean.JJSprint_.project}", JJProject.class));
		projectEditInput.setCompleteMethod(expressionFactory
				.createMethodExpression(elContext,
						"#{jJSprintBean.completeProject}", List.class,
						new Class[] { String.class }));
		projectEditInput.setDropdown(true);
		projectEditInput.setValueExpression("var", expressionFactory
				.createValueExpression(elContext, "project", String.class));
		projectEditInput
				.setValueExpression(
						"itemLabel",
						expressionFactory
								.createValueExpression(
										...
										"#{project.name} #{project.description} #{project.creationDate} #{project.updatedDate}",
										String.class));
		projectEditInput.setValueExpression("itemValue",
				expressionFactory.createValueExpression(elContext,
						"#{project}", JJProject.class));
		...
		Message projectEditInputMessage = (Message) application
				.createComponent(Message.COMPONENT_TYPE);
		...
		Message buildsEditInputMessage = (Message) application
				.createComponent(Message.COMPONENT_TYPE);
		...
		HtmlOutputText obstaclesEditOutput = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		...
		HtmlOutputText obstaclesEditInput = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		...
		Message obstaclesEditInputMessage = (Message) application
				.createComponent(Message.COMPONENT_TYPE);
		...
		OutputLabel contactsEditOutput = (OutputLabel) application
				.createComponent(OutputLabel.COMPONENT_TYPE);
		...
		SelectManyMenu contactsEditInput = (SelectManyMenu) application
				.createComponent(SelectManyMenu.COMPONENT_TYPE);
		contactsEditInput.setId("contactsEditInput");
		contactsEditInput.setConverter(new JJContactConverter());
		contactsEditInput.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{jJSprintBean.selectedContacts}", List.class));
		UISelectItems contactsEditInputItems = (UISelectItems) application
				.createComponent(UISelectItems.COMPONENT_TYPE);
		contactsEditInputItems.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{jJContactBean.allJJContacts}", List.class));
		contactsEditInput.setRequired(false);
		contactsEditInputItems.setValueExpression("var", expressionFactory
				.createValueExpression(elContext, "jJContact", String.class));
		contactsEditInputItems.setValueExpression("itemLabel",
				expressionFactory.createValueExpression(elContext,
						"#{jJContact}", String.class));
		contactsEditInputItems.setValueExpression("itemValue",
				expressionFactory.createValueExpression(elContext,
						"#{jJContact}", JJContact.class));
		contactsEditInput.getChildren().add(contactsEditInputItems);
		htmlPanelGrid.getChildren().add(contactsEditInput);

		Message contactsEditInputMessage = (Message) application
				.createComponent(Message.COMPONENT_TYPE);
	...
	public HtmlPanelGrid JJSprintBean.populateViewPanel() {
		...
		enabledValue.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{jJSprintBean.JJSprint_.enabled}", String.class));
		htmlPanelGrid.getChildren().add(enabledValue);

		HtmlOutputText orderingLabel = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		orderingLabel.setId("orderingLabel");
		orderingLabel.setValue("Ordering:");
		htmlPanelGrid.getChildren().add(orderingLabel);

		HtmlOutputText orderingValue = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		orderingValue.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{jJSprintBean.JJSprint_.ordering}", String.class));
		...
		HtmlOutputText buildsLabel = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		buildsLabel.setId("buildsLabel");
		buildsLabel.setValue("Builds:");
		htmlPanelGrid.getChildren().add(buildsLabel);

		HtmlOutputText buildsValue = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		...
		HtmlOutputText obstaclesLabel = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		obstaclesLabel.setId("obstaclesLabel");
		obstaclesLabel.setValue("Obstacles:");
		htmlPanelGrid.getChildren().add(obstaclesLabel);

		HtmlOutputText obstaclesValue = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		...
		HtmlOutputText contactsLabel = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		contactsLabel.setId("contactsLabel");
		contactsLabel.setValue("Contacts:");
		htmlPanelGrid.getChildren().add(contactsLabel);

		SelectManyMenu contactsValue = (SelectManyMenu) application
				.createComponent(SelectManyMenu.COMPONENT_TYPE);
		contactsValue.setId("contactsValue");
		contactsValue.setConverter(new JJContactConverter());
		contactsValue.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{jJSprintBean.selectedContacts}", List.class));
		UISelectItems contactsValueItems = (UISelectItems) application
				.createComponent(UISelectItems.COMPONENT_TYPE);
		contactsValue.setReadonly(true);
		contactsValue.setDisabled(true);
		contactsValueItems.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{jJSprintBean.JJSprint_.contacts}", Set.class));
		contactsValueItems.setValueExpression("var", expressionFactory
				.createValueExpression(elContext, "jJContact", String.class));
		contactsValueItems
				.setValueExpression("itemLabel", expressionFactory
						.createValueExpression(elContext, "#{jJContact}",
								String.class));
		contactsValueItems.setValueExpression("itemValue", expressionFactory
				.createValueExpression(elContext, "#{jJContact}",
						JJContact.class));
	...
	public List<JJContact> JJSprintBean.completeCreatedBy(String query) {
		...
		for (JJContact jJContact : jJContactService.findAllJJContacts()) {
			String jJContactStr = String.valueOf(jJContact.getName() + " "
					+ jJContact.getDescription() + " "
					+ jJContact.getCreationDate() + " "
					+ jJContact.getUpdatedDate());
	...
	public List<JJProject> JJSprintBean.completeProject(String query) {
		...
		for (JJProject jJProject : jJProjectService.findAllJJProjects()) {
			String jJProjectStr = String.valueOf(jJProject.getName() + " "
					+ jJProject.getDescription() + " "
	...
	public void JJSprintBean.setSelectedContacts(
			List<JJContact> selectedContacts) {
	...
	public void JJSprintBean.setSelectedMessages(
			List<JJMessage> selectedMessages) {
	...
	public String JJSprintBean.delete() {
		...
		FacesMessage facesMessage = MessageFactory.getMessage(
				"message_successfully_deleted", "JJSprint");
		FacesContext.getCurrentInstance().addMessage(null, facesMessage);
		reset();
		return findAllJJSprints();
	}

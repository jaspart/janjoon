...
public Integer JJRequirement.getWorkload(){return this.workload;}

public void JJRequirement.setWorkload(Integer workload){this.workload=workload;}
...
public JJFlowStep JJRequirement.getFlowStep(){return this.flowStep;}

public void JJRequirement.setFlowStep(JJFlowStep flowStep){this.flowStep=flowStep;}

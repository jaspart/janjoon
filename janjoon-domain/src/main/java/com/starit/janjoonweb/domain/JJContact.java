...
public class JJContact {
	...
	@JoinTable(name = "JJCategoryLinkJJContact", joinColumns = {
			@javax.persistence.JoinColumn(name = "Contact_ID", referencedColumnName = "id")}, inverseJoinColumns = {
					@javax.persistence.JoinColumn(name = "Category_ID", referencedColumnName = "id")})
	private Set<JJCategory> categories = new HashSet<JJCategory>();

	@ManyToMany(fetch = FetchType.LAZY)
	@JoinTable(name = "JJRequirementLinkJJContact", joinColumns = {
			@javax.persistence.JoinColumn(name = "Contact_ID", referencedColumnName = "id")}, inverseJoinColumns = {
	...
	public boolean equals(Object object) {
		return (object instanceof JJContact) && (getId() != null)
				? getId().equals(((JJContact) object).getId())
				: (object == this);
	}
}

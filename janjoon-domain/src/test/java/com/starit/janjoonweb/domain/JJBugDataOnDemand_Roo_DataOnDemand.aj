...
public JJBug JJBugDataOnDemand.getNewTransientJJBug(int index){JJBug obj=new JJBug();setBugUp(obj,index);setCreationDate(obj,index);setDescription(obj,index);setEnabled(obj,index);setName(obj,index);setRelation(obj,index);setUpdatedDate(obj,index);return obj;}

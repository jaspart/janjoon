...
@Autowired JJFlowStepDataOnDemand JJRequirementDataOnDemand.jJFlowStepDataOnDemand;
...
public void JJRequirementDataOnDemand.setWorkload(JJRequirement obj,int index){Integer workload=new Integer(index);obj.setWorkload(workload);}
